...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loginAccess.innerHTML = `
        <div class="login-container max-w-sm mx-auto bg-purple">
            <div class= "logo-login">
                <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                    <img src="https://i.ibb.co/vYhrpzS/Aurora-Luxe-1.png" alt="Aurora-Luxe-1" border="0">
            ...
            <div class="flex items-start mb-5">
                ...
                <label for="remember" class="ms-2 text-sm font-medium text-gray-800 dark:text-gray-300">Remember me</label>
            </div>
