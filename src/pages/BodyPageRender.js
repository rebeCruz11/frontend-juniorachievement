         ...
         <ul class="space-y-2 font-medium">
            <li>
               <a href="#" class="flex items-center p-2 text-purple-900 rounded-lg dark:text-purple-100 hover:bg-purple-200 dark:hover:bg-purple-800 group">
                  <svg class="w-5 h-5 text-purple-500 transition duration-75 dark:text-purple-300 group-hover:text-purple-900 dark:group-hover:text-purple-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
            ...
            <li>
               <a href="#" class="flex items-center p-2 text-purple-900 rounded-lg dark:text-purple-100 hover:bg-purple-200 dark:hover:bg-purple-800 group">
                  <svg class="w-6 h-6 text-purple-900 dark:text-purple-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  ...
                  <span class="ms-3">Crear Producto</span>
               </a>
            </li>
            <li>
               <a href="#" class="flex items-center p-2 text-purple-900 rounded-lg dark:text-purple-100 hover:bg-purple-200 dark:hover:bg-purple-800 group">
                  <div id="theme-toggle" type="button" class="text-purple-900 dark:text-purple-100 hover:bg-purple-200 dark:hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 dark:focus:ring-purple-700 rounded-lg text-2sm p-2.5">
                     <svg id="theme-toggle-dark-icon" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586a.999.999 0 0 0-1-1.066h.002Z"></path></svg>
            ...
            <li>
               <a id="users" class="flex items-center p-2 text-purple-900 rounded-lg dark:text-purple-100 hover:bg-purple-200 dark:hover:bg-purple-800 group">
                  <svg class="flex-shrink-0 w-5 h-5 text-purple-500 transition duration-75 dark:text-purple-300 group-hover:text-purple-900 dark:group-hover:text-purple-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                     <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
                  </svg>
                  <span class="ms-3">Ver usuarios</span>
               </a>
            </li>
            <li>
               <a href="#" class="flex items-center p-2 text-purple-900 rounded-lg dark:text-purple-100 hover:bg-purple-200 dark:hover:bg-purple-800 group">
